...
*
* ARGUMENTS:  forwardString is a pointer to a non-NULL terminated string, and strLen
*			  is the length of that string
*
* RETURNS:    0 on success, -1 if forwardString is NULL, or -2 if strLen is zero or less
*
* NOTES:      Prints a non-null terminated string backwards and then prints a newline
*
*/
